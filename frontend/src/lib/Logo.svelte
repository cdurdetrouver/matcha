...
<a href="/" class="flex flex-row items-center gap-5">
	<img src="limousine.png" alt="Limousine.org" class="h-20" />
	<p class="font-black text-white">X</p>
	<svg
		id="Calque_1"
		data-name="Calque 1"
	...
	>
		...
		<path
			class="cls-1"
			d="M201.48,6.02v8.76h8.76v8.76h8.76V6.02h-17.52ZM201.48,23.52h-8.76v8.76h8.76v-8.76Z"
		></path>
	</svg>
</a>
