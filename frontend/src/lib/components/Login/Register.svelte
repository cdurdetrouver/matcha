...
<main class="flex flex-col gap-4">
    <form class="flex flex-col gap-2 items-start" method="POST" action="?/register">
        <div class="w-full">
            <h2>Email:</h2>
            <input class="input w-2/3 px-2" type="email" name="email" placeholder="Email..." value={form?.email ?? ''} />
        ...
        <div class="w-full">
            <h2>Username:</h2>
            <input class="input w-2/3 px-2" type="text" name="username" placeholder="Username..." value={form?.username ?? ''} />
        ...
        <div class="w-full">
            ...
            <input class="input w-2/3 px-2" type="password" name="password-verif" placeholder="Password..." />
    ...
    <div class="flex flex-col gap-3 items-center">
        <a class="btn variant-filled mx-20 flex gap-4"><img class="h-[1em]" src="logo/42Paris.svg" alt="42 paris logo">Register with Intra</a>
        <a class="btn bg-white mx-20 flex gap-4"><img class="h-[1em]" src="logo/Google.svg" alt="Google logo">Register with Google</a>
    </div>
</main>